...
This repository contains the openmrs-owa-referenceappui OpenMRS Open Web App.
...
This will create a file called `openmrs-owa-referenceappui.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/justmesam/openmrs-standalone-2.4/appdata/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/justmesam/openmrs-standalone-2.4/appdata/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/justmesam/openmrs-standalone-2.4/appdata/owa",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/openmrs-owa-referenceappui/index.html"
}
```
