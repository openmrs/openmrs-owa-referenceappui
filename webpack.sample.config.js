 ...
 */
// generated on 2018-02-03 using generator-openmrs-owa 0.6.0
'use strict';
...
const THIS_APP_ID = 'openmrs-owa-referenceappui';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      'LOCAL_OWA_FOLDER': '//Users/justmesam/Documents/apprenticeships/standalone/referenceapplication-standalone-2.6.1/appdata\\owa/',
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/openmrs-owa-referenceappui`,
	  css: `${__dirname}/app/css/openmrs-owa-referenceappui.css`,
	  vendor : [
